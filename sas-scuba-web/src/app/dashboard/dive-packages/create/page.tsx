...
import { Package, User, DollarSign, Calendar, ArrowLeft } from "lucide-react";
...
export default function CreateDivePackagePage() {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-slate-50/50 dark:bg-slate-900/50">
            <Header title="Create Dive Package" />
            <div className="flex-1 space-y-6 p-8 pt-6">
                <div className="flex items-center gap-4">
                    <Link href="/dashboard/dive-packages">
                    ...
                    <div>
                        <h2 className="text-3xl font-bold tracking-tight">Create Dive Package</h2>
                        ...
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                            <Card className="shadow-sm border-slate-200 dark:border-slate-800">
                                <CardHeader>
                                    ...
                                    <CardDescription>Select the customer and the base package from the price list.</CardDescription>
                                </CardHeader>
                            ...
                            <Card className="shadow-sm border-slate-200 dark:border-slate-800">
                                <CardHeader>
                                    ...
                                    <CardDescription>Configure the package details, duration, and start date.</CardDescription>
                                </CardHeader>
                                <CardContent className="space-y-6">
                                                ...
                                                <FormItem>
                                                    ...
                                                    <FormControl>
                                                        <div className="relative">
                                                            ...
                                                            <Input type="number" step="0.01" min="0" className="pl-9 bg-background/50" {...field} />
                                                        </div>
                                                    </FormControl>
                                                    <FormMessage />
                                                </FormItem>
                                    ...
                                    {perDivePrice > 0 && (
                                        <div className="p-4 bg-muted/50 rounded-lg border border-dashed">
                                            <p className="text-sm font-medium flex items-center gap-2">
                                                ...
                                                Per-Dive Price: <span className="text-primary">${perDivePrice.toFixed(2)}</span>
                                            </p>
                                        </div>
                                    )}
                                                    ...
                                                    <FormControl>
                                                        <div className="relative">
                                                            ...
                                                            <DatePicker
                                                                ...
                                                                className={cn(
                                                                    "file:text-foreground placeholder:text-muted-foreground selection:bg-primary selection:text-primary-foreground border-input h-10 w-full min-w-0 rounded-md border bg-background/50 px-3 py-1 text-base shadow-xs transition-[color,box-shadow] outline-none file:inline-flex file:h-7 file:border-0 file:bg-transparent file:text-sm file:font-medium disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] pl-9",
                                        ...
                                        render={({ field }) => (
                                            <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4 bg-background/50">
                                                ...
                                                <div className="space-y-1 leading-none">
                                                    <FormLabel className="cursor-pointer">Create bookings for all days now</FormLabel>
                                                    <FormDescription>

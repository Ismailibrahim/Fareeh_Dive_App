...
import { ArrowLeft, User, Mail, Phone, FileText, Globe, Calendar, UserCircle, Award, Building, ExternalLink } from "lucide-react";
...
function CreateCustomerCertificationContent() {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-slate-50/50 dark:bg-slate-900/50">
            <Header title="New Certification" />
            <div className="flex-1 space-y-6 p-8 pt-6">
                <div className="flex items-center gap-4">
                    <Link href={customerId ? `/dashboard/customers` : "/dashboard/customer-certifications"}>
                    ...
                    <div>
                        <h2 className="text-3xl font-bold tracking-tight">Add New Certification</h2>
                        <p className="text-muted-foreground">Fill in the details below to register a new certification.</p>
                    </div>
                </div>
                ...
                <div className="mx-auto max-w-3xl space-y-6">
                    ...
                    {customerId && customer && (
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Adding certification for this customer
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                    ...
                    {customerId && loadingCertifications && (
                        <Card>
                            <CardContent className="py-6">
                                <div className="flex items-center justify-center">
                                    <div className="animate-spin rounded-full h-6 w-6 border-b-2 border-primary"></div>
...
export default function CreateCustomerCertificationPage() {
    return (
        <Suspense fallback={
            <div className="flex flex-col min-h-screen bg-slate-50/50 dark:bg-slate-900/50">
                <Header title="New Certification" />
            ...
            <CreateCustomerCertificationContent />
        </Suspense>
    );
}

        ...
        <AriaCalendarCell
            ...
            className={({ isDisabled, isFocusVisible, isSelectionStart, isSelectionEnd, isSelected, isOutsideMonth }) => {
                ...
                return cn(
                    ...
                    isInRange && isDisabled && "bg-accent/50",
                    isSelected && isRangeCalendar && "bg-accent/50",
                    ...
                    isLastDayOfMonth &&
                        ...
                        isBeforeEnd &&
                        isRangeCalendar &&
                        "after:absolute after:inset-0 after:translate-x-full after:bg-gradient-to-l after:from-transparent after:to-accent/50 in-[[role=gridcell]:last-child]:after:hidden",
                    ...
                    isFirstDayOfMonth &&
                        ...
                        isAfterStart &&
                        isRangeCalendar &&
                        "after:absolute after:inset-0 after:-translate-x-full after:bg-gradient-to-r after:from-transparent after:to-accent/50 in-[[role=gridcell]:first-child]:after:hidden",
                );
            }}
        >
                ...
                return (
                    <div
                        className={cn(
                            ...
                            markedAsSelected && "bg-primary font-medium text-primary-foreground hover:bg-primary/90 hover:text-primary-foreground",
                            // Hover state for non-selected cells.
                            !isSelected && !isDisabled ? "hover:bg-accent hover:text-accent-foreground" : "",
                            !isSelected && isTodayDate ? "bg-accent/50 font-medium hover:bg-accent" : "",
                        )}
                    >
                        {formattedDate}
                        ...
                        {(isHighlighted || isTodayDate) && (
                            <div
                                className={cn(
                                    ...
                                    isDisabled ? "bg-muted-foreground/50" : markedAsSelected ? "bg-primary-foreground" : "bg-primary",
                                )}
                            />
                        )}
                    </div>

...
import { Plus, Trash2, Edit, MoreHorizontal, Building } from "lucide-react";
import {
    DropdownMenu,
    DropdownMenuContent,
    DropdownMenuItem,
...
const agencySchema = z.object({
    name: z.string().min(1, "Agency name is required.").max(255, "Name must be less than 255 characters."),
});
...
export function AgenciesList() {
    ...
    const onSubmit = async (data: AgencyFormData) => {
        try {
            if (editingAgency) {
                await agencyService.update(editingAgency.id, data);
            ...
            const errorMessage = error.response?.data?.message || "Failed to save agency.";
            alert(errorMessage);
        }
    };
    ...
    const handleDelete = async (id: number) => {
        ...
        try {
            ...
            const newTotalPages = Math.ceil((agencies.length - 1) / itemsPerPage);
            ...
            const errorMessage = error.response?.data?.message || "Failed to delete agency.";
            alert(errorMessage);
        }
    };
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                        Manage agency options for certification forms.
                    </p>
                </div>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input placeholder="e.g. PADI, SSI" {...field} />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
            ...
            {loading ? (
                ...
                <div className="rounded-lg border border-dashed p-8 text-center bg-slate-50/50 dark:bg-slate-900/20">
                    <div className="flex flex-col items-center gap-2">
                        ...
                        <h3 className="text-sm font-medium">No agencies yet</h3>
                ...
                <>
                                            ...
                                            <TableCell className="text-right">
                                                <DropdownMenu>
                                                    ...
                                                    <DropdownMenuContent align="end">
                                                        ...
                                                        <DropdownMenuItem onClick={() => handleOpenDialog(agency)}>
                    ...
                    <Pagination
                        ...
                        totalPages={Math.ceil(agencies.length / itemsPerPage)}
